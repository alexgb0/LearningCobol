      ...
      *     PERFORM APPEND-USER. *> WRITE USER INTO THE NEXT AVALIBLE INDEX
      *     PERFORM READ-SIMPLE. *> READS A RECORD FORM AN INDEX.
      *     PERFORM WRITE-SIMPLE. *> WRITE A RECORD FROM AN INDEX.
           STOP RUN.
       ...
       READ-SIMPLE.
           OPEN INPUT USERS
               ...
               READ USERS RECORD INTO WS-USER
                   INVALID KEY DISPLAY "INVALID KEY"
                   NOT INVALID KEY DISPLAY WS-USER
               END-READ.
           CLOSE USERS.
